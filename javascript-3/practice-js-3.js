...
function checkGroceryCount(arr){
    if (arr.length>5){return 'That looks like a big trip'}
    else if (arr.length=1){'1 item'}
    else if (arr.length>1 && arr.length <5){return arr.length + 'item'}
